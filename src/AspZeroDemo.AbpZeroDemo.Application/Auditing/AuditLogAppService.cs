...
using AspZeroDemo.AbpZeroDemo.Auditing.Exporting;
...
using EntityHistoryHelper = AspZeroDemo.AbpZeroDemo.EntityHistory.EntityHistoryHelper;

namespace AspZeroDemo.AbpZeroDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AbpZeroDemoAppServiceBase, IAuditLogAppService
    {
