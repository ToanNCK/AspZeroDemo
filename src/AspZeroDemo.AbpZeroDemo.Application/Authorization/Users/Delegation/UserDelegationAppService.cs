...
namespace AspZeroDemo.AbpZeroDemo.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : AbpZeroDemoAppServiceBase, IUserDelegationAppService
    {
