...
using AspZeroDemo.AbpZeroDemo.Authorization.Users.Profile.Cache;
...
using AspZeroDemo.AbpZeroDemo.Gdpr;
using AspZeroDemo.AbpZeroDemo.Net.Sms;
using AspZeroDemo.AbpZeroDemo.Security;
using AspZeroDemo.AbpZeroDemo.Storage;
using AspZeroDemo.AbpZeroDemo.Timing;

namespace AspZeroDemo.AbpZeroDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AbpZeroDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("AspZeroDemo.AbpZeroDemo",
