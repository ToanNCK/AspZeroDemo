...
namespace AspZeroDemo.AbpZeroDemo.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : AbpZeroDemoAppServiceBase, IDashboardCustomizationAppService
    {
