...
namespace AspZeroDemo.AbpZeroDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AbpZeroDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AbpZeroDemoDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{AbpZeroDemoConsts.ConnectionStringName}", constring);
        }
