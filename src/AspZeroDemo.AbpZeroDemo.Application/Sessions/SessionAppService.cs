...
{
    public class SessionAppService : AbpZeroDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = AbpZeroDemoConsts.Currency,
                    CurrencySign = AbpZeroDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = AbpZeroDemoConsts.AllowTenantsToChangeEmailSettings,
