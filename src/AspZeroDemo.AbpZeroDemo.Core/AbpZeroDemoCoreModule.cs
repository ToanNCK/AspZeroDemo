...
using AspZeroDemo.AbpZeroDemo.Authorization.Ldap;
...
using AspZeroDemo.AbpZeroDemo.DashboardCustomization.Definitions;
using AspZeroDemo.AbpZeroDemo.Debugging;
using AspZeroDemo.AbpZeroDemo.DynamicEntityParameters;
using AspZeroDemo.AbpZeroDemo.Features;
...
using AspZeroDemo.AbpZeroDemo.Net.Emailing;
using AspZeroDemo.AbpZeroDemo.Notifications;
using AspZeroDemo.AbpZeroDemo.WebHooks;

namespace AspZeroDemo.AbpZeroDemo
{
    [DependsOn(
        typeof(AbpZeroDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class AbpZeroDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            AbpZeroDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = AbpZeroDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, AbpZeroDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<AbpZeroDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AbpZeroDemoCoreModule).GetAssembly());
        }
