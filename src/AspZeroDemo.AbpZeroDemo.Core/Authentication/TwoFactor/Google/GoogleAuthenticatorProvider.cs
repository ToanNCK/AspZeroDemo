...
namespace AspZeroDemo.AbpZeroDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AbpZeroDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("AspZeroDemo.AbpZeroDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
