...
{
    public class StripeGatewayManager : AbpZeroDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "AbpZeroDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + AbpZeroDemoConsts.Currency;
        }
