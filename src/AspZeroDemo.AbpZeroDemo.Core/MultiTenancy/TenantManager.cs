...
using AspZeroDemo.AbpZeroDemo.MultiTenancy.Demo;
...
namespace AspZeroDemo.AbpZeroDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(AbpZeroDemoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(AbpZeroDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
