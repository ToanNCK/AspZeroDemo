...
{
    public class AbpZeroDemoDbContext : AbpZeroDbContext<Tenant, Role, User, AbpZeroDemoDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public AbpZeroDemoDbContext(DbContextOptions<AbpZeroDemoDbContext> options)
            : base(options)
        {
