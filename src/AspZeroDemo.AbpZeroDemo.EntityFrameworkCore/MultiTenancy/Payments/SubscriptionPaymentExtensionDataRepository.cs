...
using AspZeroDemo.AbpZeroDemo.EntityFrameworkCore.Repositories;

namespace AspZeroDemo.AbpZeroDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : AbpZeroDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<AbpZeroDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
