...
{
    public class SubscriptionPaymentRepository : AbpZeroDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<AbpZeroDemoDbContext> dbContextProvider)
