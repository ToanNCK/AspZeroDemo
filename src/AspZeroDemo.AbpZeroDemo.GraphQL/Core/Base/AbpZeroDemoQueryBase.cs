...
namespace AspZeroDemo.AbpZeroDemo.Core.Base
{
    public abstract class AbpZeroDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected AbpZeroDemoQueryBase(string fieldName,
