...
using AspZeroDemo.AbpZeroDemo.Core.Base;
using AspZeroDemo.AbpZeroDemo.Core.Extensions;
using AspZeroDemo.AbpZeroDemo.Dto;
using AspZeroDemo.AbpZeroDemo.Types;

namespace AspZeroDemo.AbpZeroDemo.Queries
{
    public class OrganizationUnitQuery : AbpZeroDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
