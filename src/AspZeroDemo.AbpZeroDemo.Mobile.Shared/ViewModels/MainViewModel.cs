...
using AspZeroDemo.AbpZeroDemo.Services.Navigation;
...
using AspZeroDemo.AbpZeroDemo.Controls;
using AspZeroDemo.AbpZeroDemo.Dto;
using AspZeroDemo.AbpZeroDemo.Extensions;
using AspZeroDemo.AbpZeroDemo.Localization;
using AspZeroDemo.AbpZeroDemo.UI;
using AspZeroDemo.AbpZeroDemo.UI.Assets;
using AspZeroDemo.AbpZeroDemo.Views;
using DependencyResolver = AspZeroDemo.AbpZeroDemo.Core.Dependency.DependencyResolver;
...
namespace AspZeroDemo.AbpZeroDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "AbpZeroDemo";
