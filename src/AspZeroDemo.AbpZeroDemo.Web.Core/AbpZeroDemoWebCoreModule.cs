...
using AspZeroDemo.AbpZeroDemo.Startup;
using AspZeroDemo.AbpZeroDemo.Web.Authentication.JwtBearer;
using AspZeroDemo.AbpZeroDemo.Web.Authentication.TwoFactor;
using AspZeroDemo.AbpZeroDemo.Web.Chat.SignalR;
using AspZeroDemo.AbpZeroDemo.Web.Configuration;
using AspZeroDemo.AbpZeroDemo.Web.DashboardCustomization;

namespace AspZeroDemo.AbpZeroDemo.Web
{
    [DependsOn(
        typeof(AbpZeroDemoApplicationModule),
        typeof(AbpZeroDemoEntityFrameworkCoreModule),
        typeof(AbpAspNetZeroCoreWebModule),
        typeof(AbpAspNetCoreSignalRModule),
        typeof(AbpZeroDemoGraphQLModule),
        typeof(AbpRedisCacheModule), //AbpRedisCacheModule dependency (and Abp.RedisCache nuget package) can be removed if not using Redis cache
        typeof(AbpHangfireAspNetCoreModule) //AbpHangfireModule dependency (and Abp.Hangfire.AspNetCore nuget package) can be removed if not using Hangfire
    )]
    public class AbpZeroDemoWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AbpZeroDemoWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(AbpZeroDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AbpZeroDemoWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(AbpZeroDemoWebCoreModule).Assembly);
        }
