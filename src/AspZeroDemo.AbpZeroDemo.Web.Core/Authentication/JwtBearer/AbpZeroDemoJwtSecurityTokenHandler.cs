...
namespace AspZeroDemo.AbpZeroDemo.Web.Authentication.JwtBearer
{
    public class AbpZeroDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public AbpZeroDemoJwtSecurityTokenHandler()
        {
