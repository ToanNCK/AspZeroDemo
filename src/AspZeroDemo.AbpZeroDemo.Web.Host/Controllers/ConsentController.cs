...
using AspZeroDemo.AbpZeroDemo.Web.Models.Consent;

namespace AspZeroDemo.AbpZeroDemo.Web.Host.Controllers
{
    public class ConsentController : AbpZeroDemoControllerBase
    {
