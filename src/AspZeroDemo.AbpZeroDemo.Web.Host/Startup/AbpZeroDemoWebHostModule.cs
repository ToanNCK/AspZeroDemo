...
using AspZeroDemo.AbpZeroDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace AspZeroDemo.AbpZeroDemo.Web.Startup
{
    ...
    public class AbpZeroDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AbpZeroDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AbpZeroDemoWebHostModule).GetAssembly());
        }
