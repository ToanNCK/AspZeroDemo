...
using AspZeroDemo.AbpZeroDemo.Web.Areas.AppZeroDemo.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : AbpZeroDemoControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var userDashboard = await DashboardCustomizationAppService.GetUserDashboard(
                new GetDashboardInput
                {
                    ...
                    Application = AbpZeroDemoDashboardCustomizationConsts.Applications.Mvc
                }
            );
            ...
            return PartialView("~/Areas/AppZeroDemo/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml", viewModel);
        }
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            ...
            return View("~/Areas/AppZeroDemo/Views/Shared/Components/CustomizableDashboard/Index.cshtml",
