...
using AspZeroDemo.AbpZeroDemo.Authorization.Impersonation;
...
using AspZeroDemo.AbpZeroDemo.Net.Sms;
using AspZeroDemo.AbpZeroDemo.Notifications;
using AspZeroDemo.AbpZeroDemo.Web.Models.Account;
using AspZeroDemo.AbpZeroDemo.Security;
using AspZeroDemo.AbpZeroDemo.Security.Recaptcha;
using AspZeroDemo.AbpZeroDemo.Sessions;
using AspZeroDemo.AbpZeroDemo.Url;
using AspZeroDemo.AbpZeroDemo.Web.Authentication.External;
using AspZeroDemo.AbpZeroDemo.Web.Security.Recaptcha;
using AspZeroDemo.AbpZeroDemo.Web.Session;
using AspZeroDemo.AbpZeroDemo.Web.Views.Shared.Components.TenantChange;

namespace AspZeroDemo.AbpZeroDemo.Web.Controllers
{
    public class AccountController : AbpZeroDemoControllerBase
    {
        ...
        {
            return RedirectToAction("Index", "Home", new { area = "AppZeroDemo" });
        }

        public string GetAppHomeUrl()
        {
            return Url.Action("Index", "Home", new { area = "AppZeroDemo" });
        }
