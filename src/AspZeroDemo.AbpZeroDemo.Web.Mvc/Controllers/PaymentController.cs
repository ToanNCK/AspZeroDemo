...
using AspZeroDemo.AbpZeroDemo.Web.Models.Payment;
using System;
...
{
    public class PaymentController : AbpZeroDemoControllerBase
    {
                ...
                if (tenant.EditionId.HasValue)
                {
                    ...
                    if (((SubscribableEdition)currentEdition).IsFree)
                    {
                        ...
                        if (((SubscribableEdition)upgradeEdition).IsFree)
                        {
                            ...
                            return RedirectToAction("Index", "SubscriptionManagement", new { area = "AppZeroDemo" });
                        }
