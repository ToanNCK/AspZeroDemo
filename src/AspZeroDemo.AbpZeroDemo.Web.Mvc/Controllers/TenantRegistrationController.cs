...
using AspZeroDemo.AbpZeroDemo.Web.Models.TenantRegistration;

namespace AspZeroDemo.AbpZeroDemo.Web.Controllers
{
    public class TenantRegistrationController : AbpZeroDemoControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new { area = "AppZeroDemo" }));
                    }
