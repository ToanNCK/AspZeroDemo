(function () {
    app.modals.EntityTypeHistoryModal = function () {
        ...
        function showEntityChangeDetails(entityChange) {
            var entityChangeDetailModal = new app.ModalManager({
                viewUrl: abp.appPath + 'AppZeroDemo/AuditLogs/EntityChangeDetailModal',
    ...
    app.modals.EntityTypeHistoryModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Common/EntityTypeHistoryModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Common/Modals/_EntityTypeHistoryModal.js',
