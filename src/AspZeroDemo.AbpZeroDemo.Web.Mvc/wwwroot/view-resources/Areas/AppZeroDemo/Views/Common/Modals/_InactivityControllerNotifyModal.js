(function () {
    ...
    app.modals.InactivityControllerNotifyModal.create = function () {
        var modal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Common/InactivityControllerNotifyModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Common/Modals/_InactivityControllerNotifyModal.js',
