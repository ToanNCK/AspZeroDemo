(function () {
    ...
    app.modals.PermissionTreeModal.create = function (options) {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Common/PermissionTreeModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Common/Modals/_PermissionTreeModal.js',
