$(function () {
    ...
    var url = abp.appPath + 'AppZeroDemo/DemoUiComponents/UploadFile';
    $('#fileupload').fileupload({
        ...
        dropZone: $('#fileuploadForm'),
            ...
            if (jsonResult.success) {
                var fileUrl = abp.appPath + 'AppZeroDemo/DemoUiComponents/GetFile?id=' + jsonResult.result.id + '&contentType=' + jsonResult.result.contentType;
