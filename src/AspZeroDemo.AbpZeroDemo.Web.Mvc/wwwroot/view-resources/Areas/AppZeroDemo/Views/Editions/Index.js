(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Editions/_CreateModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Editions/_EditModal.js',
            modalClass: 'CreateOrEditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
