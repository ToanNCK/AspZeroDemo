(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/EntityDynamicParameter/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/EntityDynamicParameters/_CreateModal.js',
        ...
        _table.find('tbody').on('click', 'tr', function () {
            ...
            if (data) {
                window.location = "/AppZeroDemo/EntityDynamicParameter/Detail/" + data.entityFullName;
            }
        });
