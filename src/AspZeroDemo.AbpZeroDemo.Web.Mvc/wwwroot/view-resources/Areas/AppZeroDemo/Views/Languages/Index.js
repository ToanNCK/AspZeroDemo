(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Languages/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Languages/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                document.location.href = abp.appPath + "AppZeroDemo/Languages/Texts?languageName=" + data.record.name;
                            }
                        }, {
