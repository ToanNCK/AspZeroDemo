(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Profile/_LinkedAccountsModal.js',
        ...
        var userDelegationsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Profile/UserDelegationsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Profile/_UserDelegationsModal.js',
