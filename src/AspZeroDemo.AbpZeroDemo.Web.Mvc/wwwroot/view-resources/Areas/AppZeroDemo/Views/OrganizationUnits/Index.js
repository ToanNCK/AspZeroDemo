(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/OrganizationUnits/_EditModal.js',
            modalClass: 'EditOrganizationUnitModal'
        });

        var _addUserModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/OrganizationUnits/AddMemberModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/OrganizationUnits/_AddMemberModal.js',
        ...
        var _addRoleModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/OrganizationUnits/AddRoleModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/OrganizationUnits/_AddRoleModal.js',
