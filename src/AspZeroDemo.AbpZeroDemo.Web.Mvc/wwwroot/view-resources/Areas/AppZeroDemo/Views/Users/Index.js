(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Users/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Users/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditUserModal'
        });

        var _userPermissionsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/Users/PermissionsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/Users/_PermissionsModal.js',
            modalClass: 'UserPermissionsModal'
        });

        var _dynamicParametersModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AppZeroDemo/EntityDynamicParameterValue/ManageEntityDynamicParameterValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AppZeroDemo/Views/_Bundles/manage-entity-dynamic-parameter-values-modal-min.js',
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                _dynamicParametersModal.open({
                                    entityFullName: 'AspZeroDemo.AbpZeroDemo.Authorization.Users.User',
