...
using AspZeroDemo.AbpZeroDemo.Web.Public.Startup;
using AspZeroDemo.AbpZeroDemo.Web.Session;

namespace AspZeroDemo.AbpZeroDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : AbpZeroDemoViewComponent
    {
